...
const textoDesconto = document.querySelector('.valor-desconto')
const informacao = document.querySelector('.button-duvida');
...
const listaTeclado = document.querySelectorAll('.botao-teclado');
const palavraSorteada = document.querySelector('.palavra-sorteada');
...
let dicas = {
    ...
    "MEIA": [
        "Pode ser usada com tênis ou sapato.",
...
informacao.addEventListener('click', function () {
    instrucoes.classList.toggle('class-hover');
    informacao.classList.toggle('fundo-vermelho');
});
